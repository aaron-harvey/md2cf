/**
 * Modified version of
 * https://github.com/qjebbs/vscode-markdown-extended/blob/master/src/plugin/markdownItAdmonition.ts
 * the markdown-it-admonition library doesn't seem to be supported anymore
 */
